    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                >
                    <span
                        class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300"
                    >
                        ...
                        <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-700 bg-white dark:bg-slate-800">
                                ...
                                >
                                    ...
                                    <td
                                        class="max-w-[16rem] truncate px-6 py-4 text-sm text-slate-600 dark:text-slate-300"
                                    >
                                        {{ transfer.description || '-' }}
                                    </td>
                                    <td
                                        class="whitespace-nowrap px-6 py-4 text-right text-sm font-semibold text-slate-700 dark:text-slate-200"
                                    >
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                        <span
                                            class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400"
                                        >
                                            <ArrowsRightLeftIcon
                                                class="h-4 w-4"
                                            />
