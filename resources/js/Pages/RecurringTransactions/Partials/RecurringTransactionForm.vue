...
const typeOptions = [
    {
        value: 'income',
        label: 'Income',
        active: 'border-emerald-400 bg-emerald-50 text-emerald-700 dark:text-emerald-400',
        radio: 'text-emerald-500 focus:ring-emerald-500',
    },
    {
        value: 'expense',
        label: 'Expense',
        active: 'border-red-400 bg-red-50 text-red-700 dark:text-red-400',
                ...
                <label
                    ...
                    :class="
                        form.type === option.value
                            ? option.active
                            : 'border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'
                    "
                >
                    <input
                        type="radio"
        ...
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input
                    id="start_date"
                    type="date"
                    class="mt-1 block w-full rounded-lg border-slate-300 bg-white text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 sm:max-w-xs"
